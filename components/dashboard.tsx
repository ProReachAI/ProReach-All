...
function ConnectionsView({ project, connections: initialConnections, initialSelectionId, onConnectionsChange }: { project: ProductProject | null; connections: ConnectionSummary[]; initialSelectionId?: string; onConnectionsChange: (connections: ConnectionSummary[]) => void }) {
  const [connections, setConnections] = useState(initialConnections);
